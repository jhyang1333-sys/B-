            ...
            for idx_r1 in range(gauss_size):
                ...
                for idx_r2 in range(gauss_size):
                    ...
                    if c_col != 0:
                        ...
                        if scalar_pref_nonzero and len(coeff_c) > 0:
                            for idx in range(len(coeff_c)):
                                radial_values = _radial_factor_components_numba(
                                    r1,
                                    r2,
                                ...
                                if col_dr1 != 0.0 and r1 != 0.0:
                                    ...
                                    point_ki += coeff * g1 * pref_mu_mix * base_mix_r1_zero
                                    point_ma += coeff * g1 * pref_mass_mix * base_mix_r1_zero
                                ...
                                if col_dr2 != 0.0 and r2 != 0.0:
                                    ...
                                    point_ki += coeff * g1 * pref_mu_mix * base_mix_r2_zero
                                    point_ma += coeff * g1 * pref_mass_mix * base_mix_r2_zero
