                    ...
                    for term_col in col_terms:
                        ...
                        for corr_term in self._iter_correlation_terms(c_total):
                            ...
                            if g1 != 0.0:
                                ...
                                # Mixed ??{r1}??{r2} contribution using c_total.
                                if pref_cross != 0.0:
                        ...
                        # Terms stemming from ??{ri}??{r12} acting on the correlation factor.
                        ...
                        c_plus = c_total + 2
                        # Remaining part of ??{r1}??{r2} that raises the correlation power.
                        if c_plus >= -1:
